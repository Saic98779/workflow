...
@Data
@ToString
@Table(name="organization_temp")
public class OrganizationTemp {
    @Id
    @Column(name="organization_temp_id")
    ...
    @OneToMany(targetEntity = ParticipantTemp.class, cascade = CascadeType.ALL, mappedBy = "organizationTemp")
    @Column(name = "participants_temp")
    private List<ParticipantTemp> participantsTemp;
    ...
    @ManyToMany
    @JoinTable(
            name = "organization_temp_sector",
            joinColumns = @JoinColumn(name = "organization_temp_id"),

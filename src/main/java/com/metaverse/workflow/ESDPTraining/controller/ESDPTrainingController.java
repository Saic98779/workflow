...
public class ESDPTrainingController {
    ...
    public ResponseEntity<WorkflowResponse> SaveESDPTraining(Principal principal, @RequestBody ESDPTrainingRequest esdpTrainingRequest, HttpServletRequest servletRequest)
    {
        WorkflowResponse response=  esdpTrainingService.saveESDPTrainingProgram(esdpTrainingRequest);
        logService.logs(principal.getName(), "SAVE","ESDPTraining details saved successfully","Counsellor", servletRequest.getRequestURI());
